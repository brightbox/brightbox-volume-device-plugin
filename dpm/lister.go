...
// PluginNameListSync supplies a PluginNameList and an optional WaitGroup that will be
// marked Done when all the plugin changes have concluded
type PluginNameListSync struct {
	Names  PluginNameList
...
type ListerInterface interface {
	...
	Discover(chan PluginNameListSync)
